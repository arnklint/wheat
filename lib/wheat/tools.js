...
var Helpers = {
  ...
  avgReadingTime: function avgReadingTime(markdown) {
    var html = Markdown.encode(markdown);
    return (html.split(" ").length / 33) | 0; // average words per minute according to http://en.wikipedia.org/wiki/Words_per_minute
  },
